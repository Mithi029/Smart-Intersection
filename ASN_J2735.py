...
class AddGrpB:
    ...
    #-----< AddGrpB-Angle >-----#
    AddGrpB_Angle = INT(name='AddGrpB-Angle', mode=MODE_TYPE)
    AddGrpB_Angle._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=239)], ev=None, er=[])
    ...
    #-----< AddGrpB-Elevation >-----#
    AddGrpB_Elevation = INT(name='AddGrpB-Elevation', mode=MODE_TYPE)
    AddGrpB_Elevation._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=-32768, ub=32767)], ev=None, er=[])
    ...
    #-----< AddGrpB-MsgCount >-----#
    AddGrpB_MsgCount = INT(name='AddGrpB-MsgCount', mode=MODE_TYPE)
    AddGrpB_MsgCount._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=255)], ev=None, er=[])
    ...
    _Position3D_addGrpB_elevation = INT(name='elevation', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('AddGrpB', 'AddGrpB-Elevation')))
    ...
    #-----< AddGrpB-TimeMark >-----#
    AddGrpB_TimeMark = SEQ(name='AddGrpB-TimeMark', mode=MODE_TYPE)
    _AddGrpB_TimeMark_year = INT(name='year', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('AddGrpB', 'Year')))
    _AddGrpB_TimeMark_month = INT(name='month', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('AddGrpB', 'Month')))
    _AddGrpB_TimeMark_day = INT(name='day', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('AddGrpB', 'Day')))
    _AddGrpB_TimeMark_summerTime = ENUM(name='summerTime', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('AddGrpB', 'SummerTime')))
    _AddGrpB_TimeMark_holiday = ENUM(name='holiday', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('AddGrpB', 'Holiday')))
    _AddGrpB_TimeMark_dayofWeek = ENUM(name='dayofWeek', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('AddGrpB', 'DayOfWeek')))
    _AddGrpB_TimeMark_hour = INT(name='hour', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('AddGrpB', 'Hour')))
    _AddGrpB_TimeMark_minute = INT(name='minute', mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('AddGrpB', 'Minute')))
    _AddGrpB_TimeMark_second = INT(name='second', mode=MODE_TYPE, tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('AddGrpB', 'Second')))
    _AddGrpB_TimeMark_tenthSecond = INT(name='tenthSecond', mode=MODE_TYPE, tag=(9, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('AddGrpB', 'TenthSecond')))
    AddGrpB_TimeMark._cont = ASN1Dict([
        ('year', _AddGrpB_TimeMark_year),
        ('month', _AddGrpB_TimeMark_month),
        ('day', _AddGrpB_TimeMark_day),
        ('summerTime', _AddGrpB_TimeMark_summerTime),
        ('holiday', _AddGrpB_TimeMark_holiday),
        ('dayofWeek', _AddGrpB_TimeMark_dayofWeek),
        ('hour', _AddGrpB_TimeMark_hour),
        ('minute', _AddGrpB_TimeMark_minute),
        ('second', _AddGrpB_TimeMark_second),
        ('tenthSecond', _AddGrpB_TimeMark_tenthSecond),
        ])
    AddGrpB_TimeMark._ext = None
    ...
    _all_ = [
        ...
        Position3D_addGrpB,
        _AddGrpB_TimeMark_year,
        _AddGrpB_TimeMark_month,
        _AddGrpB_TimeMark_day,
        _AddGrpB_TimeMark_summerTime,
        _AddGrpB_TimeMark_holiday,
        _AddGrpB_TimeMark_dayofWeek,
        _AddGrpB_TimeMark_hour,
        _AddGrpB_TimeMark_minute,
        _AddGrpB_TimeMark_second,
        _AddGrpB_TimeMark_tenthSecond,
        AddGrpB_TimeMark,
    ]
...
class NYCEventDataUpload:

    _name_  = 'NYCEventDataUpload'
    _oid_   = []
    ...
    #-----< NycCvpdEvent >-----#
    NycCvpdEvent = SEQ(name='NycCvpdEvent', mode=MODE_TYPE)
    _NycCvpdEvent_eventHeader = SEQ(name='eventHeader', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'EventHeader')))
    _NycCvpdEvent_bsmList = SEQ_OF(name='bsmList', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    __NycCvpdEvent_bsmList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('NYCEventDataUpload', 'BSMEvent')))
    _NycCvpdEvent_bsmList._cont = __NycCvpdEvent_bsmList__item_
    _NycCvpdEvent_mapList = SEQ_OF(name='mapList', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    __NycCvpdEvent_mapList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('NYCEventDataUpload', 'MAPEvent')))
    _NycCvpdEvent_mapList._cont = __NycCvpdEvent_mapList__item_
    _NycCvpdEvent_spatList = SEQ_OF(name='spatList', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    __NycCvpdEvent_spatList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('NYCEventDataUpload', 'SPaTEvent')))
    _NycCvpdEvent_spatList._cont = __NycCvpdEvent_spatList__item_
    _NycCvpdEvent_timList = SEQ_OF(name='timList', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    __NycCvpdEvent_timList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('NYCEventDataUpload', 'TIMEvent')))
    _NycCvpdEvent_timList._cont = __NycCvpdEvent_timList__item_
    NycCvpdEvent._cont = ASN1Dict([
        ('eventHeader', _NycCvpdEvent_eventHeader),
        ('bsmList', _NycCvpdEvent_bsmList),
        ('mapList', _NycCvpdEvent_mapList),
        ('spatList', _NycCvpdEvent_spatList),
        ('timList', _NycCvpdEvent_timList),
        ])
    NycCvpdEvent._ext = []
    
    #-----< NycCvpdRSURF >-----#
    NycCvpdRSURF = SEQ_OF(name='NycCvpdRSURF', mode=MODE_TYPE)
    _NycCvpdRSURF__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('NYCEventDataUpload', 'BSMRecordRSURF')))
    NycCvpdRSURF._cont = _NycCvpdRSURF__item_
    
    #-----< NycCvpdASDRF >-----#
    NycCvpdASDRF = SEQ(name='NycCvpdASDRF', mode=MODE_TYPE)
    _NycCvpdASDRF_asdSerialNumber = STR_VIS(name='asdSerialNumber', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _NycCvpdASDRF_bsmRFList = SEQ_OF(name='bsmRFList', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    __NycCvpdASDRF_bsmRFList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('NYCEventDataUpload', 'BSMRecordASDRF')))
    _NycCvpdASDRF_bsmRFList._cont = __NycCvpdASDRF_bsmRFList__item_
    _NycCvpdASDRF_mapRFList = SEQ_OF(name='mapRFList', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    __NycCvpdASDRF_mapRFList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('NYCEventDataUpload', 'MAPRecordRF')))
    _NycCvpdASDRF_mapRFList._cont = __NycCvpdASDRF_mapRFList__item_
    _NycCvpdASDRF_spatRFList = SEQ_OF(name='spatRFList', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    __NycCvpdASDRF_spatRFList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('NYCEventDataUpload', 'SPaTRecordRF')))
    _NycCvpdASDRF_spatRFList._cont = __NycCvpdASDRF_spatRFList__item_
    _NycCvpdASDRF_timRFList = SEQ_OF(name='timRFList', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    __NycCvpdASDRF_timRFList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('NYCEventDataUpload', 'TIMRecordRF')))
    _NycCvpdASDRF_timRFList._cont = __NycCvpdASDRF_timRFList__item_
    NycCvpdASDRF._cont = ASN1Dict([
        ('asdSerialNumber', _NycCvpdASDRF_asdSerialNumber),
        ('bsmRFList', _NycCvpdASDRF_bsmRFList),
        ('mapRFList', _NycCvpdASDRF_mapRFList),
        ('spatRFList', _NycCvpdASDRF_spatRFList),
        ('timRFList', _NycCvpdASDRF_timRFList),
        ])
    NycCvpdASDRF._ext = None
    
    #-----< NycCvpdTravelTime >-----#
    NycCvpdTravelTime = SEQ(name='NycCvpdTravelTime', mode=MODE_TYPE)
    _NycCvpdTravelTime_bsmList = SEQ_OF(name='bsmList', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    __NycCvpdTravelTime_bsmList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('NYCEventDataUpload', 'BSMRecordTravelTime')))
    _NycCvpdTravelTime_bsmList._cont = __NycCvpdTravelTime_bsmList__item_
    NycCvpdTravelTime._cont = ASN1Dict([
        ('bsmList', _NycCvpdTravelTime_bsmList),
        ])
    NycCvpdTravelTime._ext = []
    
    #-----< BSMRecordTravelTime >-----#
    BSMRecordTravelTime = SEQ(name='BSMRecordTravelTime', mode=MODE_TYPE)
    _BSMRecordTravelTime_msgHeader = SEQ(name='msgHeader', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'MsgHeader')))
    _BSMRecordTravelTime_geoZone = INT(name='geoZone', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'GeoZone')))
    _BSMRecordTravelTime_bsmMsg = SEQ(name='bsmMsg', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'BasicSafetyMessage')))
    BSMRecordTravelTime._cont = ASN1Dict([
        ('msgHeader', _BSMRecordTravelTime_msgHeader),
        ('geoZone', _BSMRecordTravelTime_geoZone),
        ('bsmMsg', _BSMRecordTravelTime_bsmMsg),
        ])
    BSMRecordTravelTime._ext = None
    
    #-----< GeoZone >-----#
    GeoZone = INT(name='GeoZone', mode=MODE_TYPE)
    GeoZone._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=128)], ev=None, er=[])
    
    #-----< NycCvpdASDMobility >-----#
    NycCvpdASDMobility = SEQ(name='NycCvpdASDMobility', mode=MODE_TYPE)
    _NycCvpdASDMobility_vehID = OCT_STR(name='vehID', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'VINstring')))
    _NycCvpdASDMobility_asdSerialNumber = STR_VIS(name='asdSerialNumber', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _NycCvpdASDMobility_locList = SEQ_OF(name='locList', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    __NycCvpdASDMobility_locList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('NYCEventDataUpload', 'VehLocRecord')))
    _NycCvpdASDMobility_locList._cont = __NycCvpdASDMobility_locList__item_
    _NycCvpdASDMobility_timeRecordResolution = ENUM(name='timeRecordResolution', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'TimeRecordResolution')))
    NycCvpdASDMobility._cont = ASN1Dict([
        ('vehID', _NycCvpdASDMobility_vehID),
        ('asdSerialNumber', _NycCvpdASDMobility_asdSerialNumber),
        ('locList', _NycCvpdASDMobility_locList),
        ('timeRecordResolution', _NycCvpdASDMobility_timeRecordResolution),
        ])
    NycCvpdASDMobility._ext = []
    
    #-----< BSMRecord >-----#
    BSMRecord = SEQ(name='BSMRecord', mode=MODE_TYPE)
    _BSMRecord_msgHeader = SEQ(name='msgHeader', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'MsgHeader')))
    _BSMRecord_bsmMsg = SEQ(name='bsmMsg', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'BasicSafetyMessage')))
    BSMRecord._cont = ASN1Dict([
        ('msgHeader', _BSMRecord_msgHeader),
        ('bsmMsg', _BSMRecord_bsmMsg),
        ])
    BSMRecord._ext = None
    
    #-----< BSMEvent >-----#
    BSMEvent = SEQ(name='BSMEvent', mode=MODE_TYPE)
    _BSMEvent_eventMsgSeqNum = INT(name='eventMsgSeqNum', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'EventMsgSeqNum')))
    _BSMEvent_bsmRecord = SEQ(name='bsmRecord', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'BSMRecord')))
    BSMEvent._cont = ASN1Dict([
        ('eventMsgSeqNum', _BSMEvent_eventMsgSeqNum),
        ('bsmRecord', _BSMEvent_bsmRecord),
        ])
    BSMEvent._ext = None
    
    #-----< BSMRecordRSURF >-----#
    BSMRecordRSURF = SEQ(name='BSMRecordRSURF', mode=MODE_TYPE)
    _BSMRecordRSURF_firstBSMTime = SEQ(name='firstBSMTime', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'DDateTime')))
    _BSMRecordRSURF_firstBSM = SEQ(name='firstBSM', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'BSMRecord')))
    _BSMRecordRSURF_lastBSMTime = SEQ(name='lastBSMTime', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'DDateTime')))
    _BSMRecordRSURF_lastBSM = SEQ(name='lastBSM', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'BSMRecord')))
    BSMRecordRSURF._cont = ASN1Dict([
        ('firstBSMTime', _BSMRecordRSURF_firstBSMTime),
        ('firstBSM', _BSMRecordRSURF_firstBSM),
        ('lastBSMTime', _BSMRecordRSURF_lastBSMTime),
        ('lastBSM', _BSMRecordRSURF_lastBSM),
        ])
    BSMRecordRSURF._ext = None
    
    #-----< BSMRecordASDRF >-----#
    BSMRecordASDRF = SEQ(name='BSMRecordASDRF', mode=MODE_TYPE)
    _BSMRecordASDRF_firstBSMTime = SEQ(name='firstBSMTime', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'DDateTime')))
    _BSMRecordASDRF_firstHVBSM = SEQ(name='firstHVBSM', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'BSMRecord')))
    _BSMRecordASDRF_firstRVBSM = SEQ(name='firstRVBSM', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'BSMRecord')))
    _BSMRecordASDRF_lastBSMTime = SEQ(name='lastBSMTime', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'DDateTime')))
    _BSMRecordASDRF_lastHVBSM = SEQ(name='lastHVBSM', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'BSMRecord')))
    _BSMRecordASDRF_lastRVBSM = SEQ(name='lastRVBSM', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'BSMRecord')))
    BSMRecordASDRF._cont = ASN1Dict([
        ('firstBSMTime', _BSMRecordASDRF_firstBSMTime),
        ('firstHVBSM', _BSMRecordASDRF_firstHVBSM),
        ('firstRVBSM', _BSMRecordASDRF_firstRVBSM),
        ('lastBSMTime', _BSMRecordASDRF_lastBSMTime),
        ('lastHVBSM', _BSMRecordASDRF_lastHVBSM),
        ('lastRVBSM', _BSMRecordASDRF_lastRVBSM),
        ])
    BSMRecordASDRF._ext = None
    
    #-----< EventHeader >-----#
    EventHeader = SEQ(name='EventHeader', mode=MODE_TYPE)
    _EventHeader_eventTimeStamp = SEQ(name='eventTimeStamp', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'DDateTime')))
    _EventHeader_locationSource = ENUM(name='locationSource', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'LocationSource')))
    _EventHeader_asdSerialNumber = STR_VIS(name='asdSerialNumber', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _EventHeader_asdFirmwareVersion = STR_VIS(name='asdFirmwareVersion', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _EventHeader_eventAlertActive = BOOL(name='eventAlertActive', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'EventAlertActive')))
    _EventHeader_eventAlertSent = BOOL(name='eventAlertSent', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'EventAlertSent')))
    _EventHeader_eventAlertHeard = BOOL(name='eventAlertHeard', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'EventAlertHeard')))
    _EventHeader_hostVehID = OCT_STR(name='hostVehID', mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'TemporaryID')))
    _EventHeader_targetVehID = OCT_STR(name='targetVehID', mode=MODE_TYPE, tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'TemporaryID')))
    _EventHeader_triggerHVSeqNum = INT(name='triggerHVSeqNum', mode=MODE_TYPE, tag=(9, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'EventMsgSeqNum')))
    _EventHeader_triggerTVSeqNum = INT(name='triggerTVSeqNum', mode=MODE_TYPE, tag=(10, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'EventMsgSeqNum')))
    _EventHeader_eventType = ENUM(name='eventType', mode=MODE_TYPE, tag=(11, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'EventType')))
    _EventHeader_parameters = SEQ(name='parameters', mode=MODE_TYPE, tag=(12, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'ParameterSet')))
    _EventHeader_grpId = INT(name='grpId', mode=MODE_TYPE, tag=(13, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'GroupId')))
    EventHeader._cont = ASN1Dict([
        ('eventTimeStamp', _EventHeader_eventTimeStamp),
        ('locationSource', _EventHeader_locationSource),
        ('asdSerialNumber', _EventHeader_asdSerialNumber),
        ('asdFirmwareVersion', _EventHeader_asdFirmwareVersion),
        ('eventAlertActive', _EventHeader_eventAlertActive),
        ('eventAlertSent', _EventHeader_eventAlertSent),
        ('eventAlertHeard', _EventHeader_eventAlertHeard),
        ('hostVehID', _EventHeader_hostVehID),
        ('targetVehID', _EventHeader_targetVehID),
        ('triggerHVSeqNum', _EventHeader_triggerHVSeqNum),
        ('triggerTVSeqNum', _EventHeader_triggerTVSeqNum),
        ('eventType', _EventHeader_eventType),
        ('parameters', _EventHeader_parameters),
        ('grpId', _EventHeader_grpId),
        ])
    EventHeader._ext = []
    
    #-----< VehLocRecord >-----#
    VehLocRecord = SEQ(name='VehLocRecord', mode=MODE_TYPE)
    _VehLocRecord_timeStamp = SEQ(name='timeStamp', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'DDateTime')))
    _VehLocRecord_longitude = INT(name='longitude', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'Longitude')))
    _VehLocRecord_latitude = INT(name='latitude', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'Latitude')))
    _VehLocRecord_elevation = INT(name='elevation', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'Elevation')))
    VehLocRecord._cont = ASN1Dict([
        ('timeStamp', _VehLocRecord_timeStamp),
        ('longitude', _VehLocRecord_longitude),
        ('latitude', _VehLocRecord_latitude),
        ('elevation', _VehLocRecord_elevation),
        ])
    VehLocRecord._ext = None
    
    #-----< EventAlertActive >-----#
    EventAlertActive = BOOL(name='EventAlertActive', mode=MODE_TYPE)
    
    #-----< EventAlertHeard >-----#
    EventAlertHeard = BOOL(name='EventAlertHeard', mode=MODE_TYPE)
    
    #-----< EventAlertSent >-----#
    EventAlertSent = BOOL(name='EventAlertSent', mode=MODE_TYPE)
    
    #-----< TIMRecord >-----#
    TIMRecord = SEQ(name='TIMRecord', mode=MODE_TYPE)
    _TIMRecord_msgHeader = SEQ(name='msgHeader', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'MsgHeader')))
    _TIMRecord_timMsg = SEQ(name='timMsg', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'TravelerInformation')))
    TIMRecord._cont = ASN1Dict([
        ('msgHeader', _TIMRecord_msgHeader),
        ('timMsg', _TIMRecord_timMsg),
        ])
    TIMRecord._ext = None
    
    #-----< TIMEvent >-----#
    TIMEvent = SEQ(name='TIMEvent', mode=MODE_TYPE)
    _TIMEvent_seqNum = INT(name='seqNum', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'EventMsgSeqNum')))
    _TIMEvent_timRecord = SEQ(name='timRecord', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'TIMRecord')))
    TIMEvent._cont = ASN1Dict([
        ('seqNum', _TIMEvent_seqNum),
        ('timRecord', _TIMEvent_timRecord),
        ])
    TIMEvent._ext = None
    
    #-----< TIMRecordRF >-----#
    TIMRecordRF = SEQ(name='TIMRecordRF', mode=MODE_TYPE)
    _TIMRecordRF_firstTIMTime = SEQ(name='firstTIMTime', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'DDateTime')))
    _TIMRecordRF_firstTIMRecord = SEQ(name='firstTIMRecord', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'TIMRecord')))
    _TIMRecordRF_lastTIMTime = SEQ(name='lastTIMTime', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'DDateTime')))
    _TIMRecordRF_lastTIMRecord = SEQ(name='lastTIMRecord', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'TIMRecord')))
    _TIMRecordRF_firstTIMLocation = SEQ(name='firstTIMLocation', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'BasicSafetyMessage')))
    _TIMRecordRF_lastTIMLocation = SEQ(name='lastTIMLocation', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'BasicSafetyMessage')))
    TIMRecordRF._cont = ASN1Dict([
        ('firstTIMTime', _TIMRecordRF_firstTIMTime),
        ('firstTIMRecord', _TIMRecordRF_firstTIMRecord),
        ('lastTIMTime', _TIMRecordRF_lastTIMTime),
        ('lastTIMRecord', _TIMRecordRF_lastTIMRecord),
        ('firstTIMLocation', _TIMRecordRF_firstTIMLocation),
        ('lastTIMLocation', _TIMRecordRF_lastTIMLocation),
        ])
    TIMRecordRF._ext = None
    
    #-----< SPaTRecord >-----#
    SPaTRecord = SEQ(name='SPaTRecord', mode=MODE_TYPE)
    _SPaTRecord_msgHeader = SEQ(name='msgHeader', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'MsgHeader')))
    _SPaTRecord_spatMsg = SEQ(name='spatMsg', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'SPAT')))
    SPaTRecord._cont = ASN1Dict([
        ('msgHeader', _SPaTRecord_msgHeader),
        ('spatMsg', _SPaTRecord_spatMsg),
        ])
    SPaTRecord._ext = None
    
    #-----< SPaTEvent >-----#
    SPaTEvent = SEQ(name='SPaTEvent', mode=MODE_TYPE)
    _SPaTEvent_seqNum = INT(name='seqNum', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'EventMsgSeqNum')))
    _SPaTEvent_spatRecord = SEQ(name='spatRecord', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'SPaTRecord')))
    SPaTEvent._cont = ASN1Dict([
        ('seqNum', _SPaTEvent_seqNum),
        ('spatRecord', _SPaTEvent_spatRecord),
        ])
    SPaTEvent._ext = None
    
    #-----< SPaTRecordRF >-----#
    SPaTRecordRF = SEQ(name='SPaTRecordRF', mode=MODE_TYPE)
    _SPaTRecordRF_firstSPaTTime = SEQ(name='firstSPaTTime', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'DDateTime')))
    _SPaTRecordRF_firstSPaTRecord = SEQ(name='firstSPaTRecord', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'SPaTRecord')))
    _SPaTRecordRF_lastSPaTTime = SEQ(name='lastSPaTTime', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'DDateTime')))
    _SPaTRecordRF_lastSPaTRecord = SEQ(name='lastSPaTRecord', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'SPaTRecord')))
    _SPaTRecordRF_firstSPaTLocation = SEQ(name='firstSPaTLocation', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'BasicSafetyMessage')))
    _SPaTRecordRF_lastSPaTLocation = SEQ(name='lastSPaTLocation', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'BasicSafetyMessage')))
    SPaTRecordRF._cont = ASN1Dict([
        ('firstSPaTTime', _SPaTRecordRF_firstSPaTTime),
        ('firstSPaTRecord', _SPaTRecordRF_firstSPaTRecord),
        ('lastSPaTTime', _SPaTRecordRF_lastSPaTTime),
        ('lastSPaTRecord', _SPaTRecordRF_lastSPaTRecord),
        ('firstSPaTLocation', _SPaTRecordRF_firstSPaTLocation),
        ('lastSPaTLocation', _SPaTRecordRF_lastSPaTLocation),
        ])
    SPaTRecordRF._ext = None
    
    #-----< MAPRecord >-----#
    MAPRecord = SEQ(name='MAPRecord', mode=MODE_TYPE)
    _MAPRecord_msgHeader = SEQ(name='msgHeader', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'MsgHeader')))
    _MAPRecord_mapMsg = SEQ(name='mapMsg', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'MapData')))
    MAPRecord._cont = ASN1Dict([
        ('msgHeader', _MAPRecord_msgHeader),
        ('mapMsg', _MAPRecord_mapMsg),
        ])
    MAPRecord._ext = None
    
    #-----< MAPEvent >-----#
    MAPEvent = SEQ(name='MAPEvent', mode=MODE_TYPE)
    _MAPEvent_seqNum = INT(name='seqNum', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'EventMsgSeqNum')))
    _MAPEvent_mapRecAct = SEQ(name='mapRecAct', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'MAPRecord')))
    MAPEvent._cont = ASN1Dict([
        ('seqNum', _MAPEvent_seqNum),
        ('mapRecAct', _MAPEvent_mapRecAct),
        ])
    MAPEvent._ext = None
    
    #-----< MAPRecordRF >-----#
    MAPRecordRF = SEQ(name='MAPRecordRF', mode=MODE_TYPE)
    _MAPRecordRF_firstMAPTime = SEQ(name='firstMAPTime', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'DDateTime')))
    _MAPRecordRF_firstMAPRecord = SEQ(name='firstMAPRecord', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'MAPRecord')))
    _MAPRecordRF_lastMAPTime = SEQ(name='lastMAPTime', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'DDateTime')))
    _MAPRecordRF_lastMAPRecord = SEQ(name='lastMAPRecord', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'MAPRecord')))
    _MAPRecordRF_firstMAPLocation = SEQ(name='firstMAPLocation', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'BasicSafetyMessage')))
    _MAPRecordRF_lastMAPLocation = SEQ(name='lastMAPLocation', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'BasicSafetyMessage')))
    MAPRecordRF._cont = ASN1Dict([
        ('firstMAPTime', _MAPRecordRF_firstMAPTime),
        ('firstMAPRecord', _MAPRecordRF_firstMAPRecord),
        ('lastMAPTime', _MAPRecordRF_lastMAPTime),
        ('lastMAPRecord', _MAPRecordRF_lastMAPRecord),
        ('firstMAPLocation', _MAPRecordRF_firstMAPLocation),
        ('lastMAPLocation', _MAPRecordRF_lastMAPLocation),
        ])
    MAPRecordRF._ext = None
    
    #-----< MsgHeader >-----#
    MsgHeader = SEQ(name='MsgHeader', mode=MODE_TYPE)
    _MsgHeader_myRFLevel = INT(name='myRFLevel', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'RFLevel')))
    _MsgHeader_authenticated = BOOL(name='authenticated', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'MsgAuthenticated')))
    MsgHeader._cont = ASN1Dict([
        ('myRFLevel', _MsgHeader_myRFLevel),
        ('authenticated', _MsgHeader_authenticated),
        ])
    MsgHeader._ext = None
    
    #-----< MsgAuthenticated >-----#
    MsgAuthenticated = BOOL(name='MsgAuthenticated', mode=MODE_TYPE)
    
    #-----< ParameterSet >-----#
    ParameterSet = SEQ(name='ParameterSet', mode=MODE_TYPE)
    _ParameterSet_recordingROI = STR_NUM(name='recordingROI', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _ParameterSet_timeRecordBefore = STR_NUM(name='timeRecordBefore', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _ParameterSet_timeRecordFollow = STR_NUM(name='timeRecordFollow', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _ParameterSet_timeRecordResolution = ENUM(name='timeRecordResolution', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('NYCEventDataUpload', 'TimeRecordResolution')))
    _ParameterSet_minSpdThreshold = STR_NUM(name='minSpdThreshold', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _ParameterSet_timeToCrash = STR_NUM(name='timeToCrash', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _ParameterSet_excessiveCurveSpd = STR_NUM(name='excessiveCurveSpd', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _ParameterSet_excessiveSpd = STR_NUM(name='excessiveSpd', mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _ParameterSet_excessiveSpdTime = STR_NUM(name='excessiveSpdTime', mode=MODE_TYPE, tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _ParameterSet_excessiveCurveSpdTime = STR_NUM(name='excessiveCurveSpdTime', mode=MODE_TYPE, tag=(9, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _ParameterSet_excessiveZoneSpd = STR_NUM(name='excessiveZoneSpd', mode=MODE_TYPE, tag=(10, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _ParameterSet_excessiveZoneSpdTime = STR_NUM(name='excessiveZoneSpdTime', mode=MODE_TYPE, tag=(11, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _ParameterSet_minCurveSpd = STR_NUM(name='minCurveSpd', mode=MODE_TYPE, tag=(12, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _ParameterSet_minZoneSpd = STR_NUM(name='minZoneSpd', mode=MODE_TYPE, tag=(13, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _ParameterSet_stopBarTolerance = STR_NUM(name='stopBarTolerance', mode=MODE_TYPE, tag=(14, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _ParameterSet_yellowDurationTolerance = STR_NUM(name='yellowDurationTolerance', mode=MODE_TYPE, tag=(15, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _ParameterSet_hardBrakingThreshold = STR_NUM(name='hardBrakingThreshold', mode=MODE_TYPE, tag=(16, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _ParameterSet_postedHeightLimit = STR_NUM(name='postedHeightLimit', mode=MODE_TYPE, tag=(17, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _ParameterSet_postedSizeLimit = STR_NUM(name='postedSizeLimit', mode=MODE_TYPE, tag=(18, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _ParameterSet_assumedDriverBraking = STR_NUM(name='assumedDriverBraking', mode=MODE_TYPE, tag=(19, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _ParameterSet_postedZoneSpeed = STR_NUM(name='postedZoneSpeed', mode=MODE_TYPE, tag=(20, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _ParameterSet_regulatorySpeed = STR_NUM(name='regulatorySpeed', mode=MODE_TYPE, tag=(21, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    ParameterSet._cont = ASN1Dict([
        ('recordingROI', _ParameterSet_recordingROI),
        ('timeRecordBefore', _ParameterSet_timeRecordBefore),
        ('timeRecordFollow', _ParameterSet_timeRecordFollow),
        ('timeRecordResolution', _ParameterSet_timeRecordResolution),
        ('minSpdThreshold', _ParameterSet_minSpdThreshold),
        ('timeToCrash', _ParameterSet_timeToCrash),
        ('excessiveCurveSpd', _ParameterSet_excessiveCurveSpd),
        ('excessiveSpd', _ParameterSet_excessiveSpd),
        ('excessiveSpdTime', _ParameterSet_excessiveSpdTime),
        ('excessiveCurveSpdTime', _ParameterSet_excessiveCurveSpdTime),
        ('excessiveZoneSpd', _ParameterSet_excessiveZoneSpd),
        ('excessiveZoneSpdTime', _ParameterSet_excessiveZoneSpdTime),
        ('minCurveSpd', _ParameterSet_minCurveSpd),
        ('minZoneSpd', _ParameterSet_minZoneSpd),
        ('stopBarTolerance', _ParameterSet_stopBarTolerance),
        ('yellowDurationTolerance', _ParameterSet_yellowDurationTolerance),
        ('hardBrakingThreshold', _ParameterSet_hardBrakingThreshold),
        ('postedHeightLimit', _ParameterSet_postedHeightLimit),
        ('postedSizeLimit', _ParameterSet_postedSizeLimit),
        ('assumedDriverBraking', _ParameterSet_assumedDriverBraking),
        ('postedZoneSpeed', _ParameterSet_postedZoneSpeed),
        ('regulatorySpeed', _ParameterSet_regulatorySpeed),
        ])
    ParameterSet._ext = []
    
    #-----< EventMsgSeqNum >-----#
    EventMsgSeqNum = INT(name='EventMsgSeqNum', mode=MODE_TYPE)
    EventMsgSeqNum._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=1, ub=16384)], ev=None, er=[])
    
    #-----< LocationSource >-----#
    LocationSource = ENUM(name='LocationSource', mode=MODE_TYPE)
    LocationSource._cont = ASN1Dict([('unknown', 0), ('directgps', 1), ('gps', 2), ('gpsrsu', 3)])
    LocationSource._ext = None
    
    #-----< EventType >-----#
    EventType = ENUM(name='EventType', mode=MODE_TYPE)
    EventType._cont = ASN1Dict([('unknown', 0), ('fcw', 1), ('eebl', 2), ('bsw', 3), ('lcw', 4), ('ima', 5), ('vtrw', 6), ('spdcomp', 7), ('cspdomp', 8), ('spdcompwz', 9), ('rlvw', 10), ('ovcturnprohibit', 11), ('ovcclearancelimit', 12), ('evacinfo', 13), ('pedinxwalk', 14), ('pedSig', 15)])
    EventType._ext = None
    
    #-----< RFLevel >-----#
    RFLevel = INT(name='RFLevel', mode=MODE_TYPE)
    RFLevel._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=-300, ub=301)], ev=None, er=[])
    
    #-----< TimeRecordResolution >-----#
    TimeRecordResolution = ENUM(name='TimeRecordResolution', mode=MODE_TYPE)
    TimeRecordResolution._cont = ASN1Dict([('resOneTenthOfSec', 0), ('resTwoTenthOfSec', 1), ('resFiveTenthsOfSec', 2), ('resEverySec', 3), ('resEveryTwoSec', 4), ('resEveryFiveSec', 5), ('resEveryTenSec', 6)])
    TimeRecordResolution._ext = None
    
    #-----< GroupId >-----#
    GroupId = INT(name='GroupId', mode=MODE_TYPE)
    GroupId._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=255)], ev=None, er=[])
    
    _all_ = [
        _NycCvpdEvent_eventHeader,
        __NycCvpdEvent_bsmList__item_,
        _NycCvpdEvent_bsmList,
        __NycCvpdEvent_mapList__item_,
        _NycCvpdEvent_mapList,
        __NycCvpdEvent_spatList__item_,
        _NycCvpdEvent_spatList,
        __NycCvpdEvent_timList__item_,
        _NycCvpdEvent_timList,
        NycCvpdEvent,
        _NycCvpdRSURF__item_,
        NycCvpdRSURF,
        _NycCvpdASDRF_asdSerialNumber,
        __NycCvpdASDRF_bsmRFList__item_,
        _NycCvpdASDRF_bsmRFList,
        __NycCvpdASDRF_mapRFList__item_,
        _NycCvpdASDRF_mapRFList,
        __NycCvpdASDRF_spatRFList__item_,
        _NycCvpdASDRF_spatRFList,
        __NycCvpdASDRF_timRFList__item_,
        _NycCvpdASDRF_timRFList,
        NycCvpdASDRF,
        __NycCvpdTravelTime_bsmList__item_,
        _NycCvpdTravelTime_bsmList,
        NycCvpdTravelTime,
        _BSMRecordTravelTime_msgHeader,
        _BSMRecordTravelTime_geoZone,
        _BSMRecordTravelTime_bsmMsg,
        BSMRecordTravelTime,
        GeoZone,
        _NycCvpdASDMobility_vehID,
        _NycCvpdASDMobility_asdSerialNumber,
        __NycCvpdASDMobility_locList__item_,
        _NycCvpdASDMobility_locList,
        _NycCvpdASDMobility_timeRecordResolution,
        NycCvpdASDMobility,
        _BSMRecord_msgHeader,
        _BSMRecord_bsmMsg,
        BSMRecord,
        _BSMEvent_eventMsgSeqNum,
        _BSMEvent_bsmRecord,
        BSMEvent,
        _BSMRecordRSURF_firstBSMTime,
        _BSMRecordRSURF_firstBSM,
        _BSMRecordRSURF_lastBSMTime,
        _BSMRecordRSURF_lastBSM,
        BSMRecordRSURF,
        _BSMRecordASDRF_firstBSMTime,
        _BSMRecordASDRF_firstHVBSM,
        _BSMRecordASDRF_firstRVBSM,
        _BSMRecordASDRF_lastBSMTime,
        _BSMRecordASDRF_lastHVBSM,
        _BSMRecordASDRF_lastRVBSM,
        BSMRecordASDRF,
        _EventHeader_eventTimeStamp,
        _EventHeader_locationSource,
        _EventHeader_asdSerialNumber,
        _EventHeader_asdFirmwareVersion,
        _EventHeader_eventAlertActive,
        _EventHeader_eventAlertSent,
        _EventHeader_eventAlertHeard,
        _EventHeader_hostVehID,
        _EventHeader_targetVehID,
        _EventHeader_triggerHVSeqNum,
        _EventHeader_triggerTVSeqNum,
        _EventHeader_eventType,
        _EventHeader_parameters,
        _EventHeader_grpId,
        EventHeader,
        _VehLocRecord_timeStamp,
        _VehLocRecord_longitude,
        _VehLocRecord_latitude,
        _VehLocRecord_elevation,
        VehLocRecord,
        EventAlertActive,
        EventAlertHeard,
        EventAlertSent,
        _TIMRecord_msgHeader,
        _TIMRecord_timMsg,
        TIMRecord,
        _TIMEvent_seqNum,
        _TIMEvent_timRecord,
        TIMEvent,
        _TIMRecordRF_firstTIMTime,
        _TIMRecordRF_firstTIMRecord,
        _TIMRecordRF_lastTIMTime,
        _TIMRecordRF_lastTIMRecord,
        _TIMRecordRF_firstTIMLocation,
        _TIMRecordRF_lastTIMLocation,
        TIMRecordRF,
        _SPaTRecord_msgHeader,
        _SPaTRecord_spatMsg,
        SPaTRecord,
        _SPaTEvent_seqNum,
        _SPaTEvent_spatRecord,
        SPaTEvent,
        _SPaTRecordRF_firstSPaTTime,
        _SPaTRecordRF_firstSPaTRecord,
        _SPaTRecordRF_lastSPaTTime,
        _SPaTRecordRF_lastSPaTRecord,
        _SPaTRecordRF_firstSPaTLocation,
        _SPaTRecordRF_lastSPaTLocation,
        SPaTRecordRF,
        _MAPRecord_msgHeader,
        _MAPRecord_mapMsg,
        MAPRecord,
        _MAPEvent_seqNum,
        _MAPEvent_mapRecAct,
        MAPEvent,
        _MAPRecordRF_firstMAPTime,
        _MAPRecordRF_firstMAPRecord,
        _MAPRecordRF_lastMAPTime,
        _MAPRecordRF_lastMAPRecord,
        _MAPRecordRF_firstMAPLocation,
        _MAPRecordRF_lastMAPLocation,
        MAPRecordRF,
        _MsgHeader_myRFLevel,
        _MsgHeader_authenticated,
        MsgHeader,
        MsgAuthenticated,
        _ParameterSet_recordingROI,
        _ParameterSet_timeRecordBefore,
        _ParameterSet_timeRecordFollow,
        _ParameterSet_timeRecordResolution,
        _ParameterSet_minSpdThreshold,
        _ParameterSet_timeToCrash,
        _ParameterSet_excessiveCurveSpd,
        _ParameterSet_excessiveSpd,
        _ParameterSet_excessiveSpdTime,
        _ParameterSet_excessiveCurveSpdTime,
        _ParameterSet_excessiveZoneSpd,
        _ParameterSet_excessiveZoneSpdTime,
        _ParameterSet_minCurveSpd,
        _ParameterSet_minZoneSpd,
        _ParameterSet_stopBarTolerance,
        _ParameterSet_yellowDurationTolerance,
        _ParameterSet_hardBrakingThreshold,
        _ParameterSet_postedHeightLimit,
        _ParameterSet_postedSizeLimit,
        _ParameterSet_assumedDriverBraking,
        _ParameterSet_postedZoneSpeed,
        _ParameterSet_regulatorySpeed,
        ParameterSet,
        EventMsgSeqNum,
        LocationSource,
        EventType,
...
class DanlawVRSU:
    ...
    _obj_ = [
        'UserClientUpload',
        'UserClientExtendedUpload',
        'PositionUpload',
        'SignalRequestElements',
        'SignalRequestType',
        'Psid',
        'SequenceOfPsid',
        ]
    ...
    #-----< UserClientUpload >-----#
    UserClientUpload = SEQ(name='UserClientUpload', mode=MODE_TYPE)
    _UserClientUpload_positionUpload = SEQ_OF(name='positionUpload', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DanlawVRSU', 'PositionUpload')))
    _UserClientUpload_supportedServicesUpload = SEQ_OF(name='supportedServicesUpload', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DanlawVRSU', 'SequenceOfPsid')))
    UserClientUpload._cont = ASN1Dict([
        ('positionUpload', _UserClientUpload_positionUpload),
        ('supportedServicesUpload', _UserClientUpload_supportedServicesUpload),
        ])
    UserClientUpload._ext = []
    
    #-----< UserClientExtendedUpload >-----#
    UserClientExtendedUpload = SEQ(name='UserClientExtendedUpload', mode=MODE_TYPE)
    _UserClientExtendedUpload_positionUpload = SEQ_OF(name='positionUpload', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DanlawVRSU', 'PositionUpload')), opt=True)
    _UserClientExtendedUpload_supportedServicesUpload = SEQ_OF(name='supportedServicesUpload', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DanlawVRSU', 'SequenceOfPsid')))
    _UserClientExtendedUpload_signalRequest = SEQ(name='signalRequest', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DanlawVRSU', 'SignalRequestElements')), opt=True)
    UserClientExtendedUpload._cont = ASN1Dict([
        ('positionUpload', _UserClientExtendedUpload_positionUpload),
        ('supportedServicesUpload', _UserClientExtendedUpload_supportedServicesUpload),
        ('signalRequest', _UserClientExtendedUpload_signalRequest),
        ])
    UserClientExtendedUpload._ext = []
    
    #-----< PositionUpload >-----#
    PositionUpload = SEQ_OF(name='PositionUpload', mode=MODE_TYPE)
    _PositionUpload__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('DSRC', 'Snapshot')))
    PositionUpload._cont = _PositionUpload__item_
    PositionUpload._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[])
    
    #-----< SignalRequestElements >-----#
    SignalRequestElements = SEQ(name='SignalRequestElements', mode=MODE_TYPE)
    _SignalRequestElements_requestType = ENUM(name='requestType', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DanlawVRSU', 'SignalRequestType')))
    _SignalRequestElements_requestIntersectionID = INT(name='requestIntersectionID', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'IntersectionID')))
    _SignalRequestElements_request = SEQ(name='request', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('DSRC', 'SignalRequestMessage')))
    SignalRequestElements._cont = ASN1Dict([
        ('requestType', _SignalRequestElements_requestType),
        ('requestIntersectionID', _SignalRequestElements_requestIntersectionID),
        ('request', _SignalRequestElements_request),
        ])
    SignalRequestElements._ext = []
    
    #-----< SignalRequestType >-----#
    SignalRequestType = ENUM(name='SignalRequestType', mode=MODE_TYPE)
    SignalRequestType._cont = ASN1Dict([('unavailable', 0), ('aPriority', 1), ('aPreemption', 2)])
    SignalRequestType._ext = []
    ...
    _SequenceOfPsid__item_ = INT(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('DanlawVRSU', 'Psid')))
    SequenceOfPsid._cont = _SequenceOfPsid__item_
    
    _all_ = [
        _UserClientUpload_positionUpload,
        _UserClientUpload_supportedServicesUpload,
        UserClientUpload,
        _UserClientExtendedUpload_positionUpload,
        _UserClientExtendedUpload_supportedServicesUpload,
        _UserClientExtendedUpload_signalRequest,
        UserClientExtendedUpload,
        _PositionUpload__item_,
        PositionUpload,
        _SignalRequestElements_requestType,
        _SignalRequestElements_requestIntersectionID,
        _SignalRequestElements_request,
        SignalRequestElements,
        SignalRequestType,
        Psid,
...
init_modules(DSRC, REGION, AddGrpC, AddGrpB, NTCIP, ITIS, NYCEventDataUpload, DanlawVRSU)
